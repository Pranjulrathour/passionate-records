...
class App {
  ...
  constructor(
    ...
    this.scroll = { ease: 0.01, current: 0, target: 0, last: 0 }; // Even much slower scroll interpolation
  ...
  onTouchMove(e: MouseEvent | TouchEvent) {
    ...
    const distance = (this.start - x) * 0.01; // Even much slower drag sensitivity
  ...
  onWheel() {
    this.scroll.target += 0.2; // Even much slower scroll speed
